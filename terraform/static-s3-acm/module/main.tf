...
resource "aws_s3_bucket" "www" {
  bucket = "www.${var.subdomain}.${var.root_domain_name}"
  ...
  "Statement":[
    {
      ...
      "Principal": "*",
      "Action":["s3:GetObject"],
      "Resource":["arn:aws:s3:::www.${var.subdomain}.${var.root_domain_name}/*"]
    }
  ]
}
POLICY
  ...
  "Statement":[
    {
      ...
      "Principal": "*",
      "Action":["s3:GetObject"],
      "Resource":["arn:aws:s3:::${var.subdomain}.${var.root_domain_name}/*"]
    }
  ]
}
POLICY
